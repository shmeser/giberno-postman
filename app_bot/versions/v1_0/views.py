...
class TelegramBotView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        self.chat = TelegramBotRepository.get_or_create_chat(
        ...
        TelegramBotRepository.create_message(self.chat, **message_data)

        TelegramBotRepository.create_message(self.chat, **{
            "is_bot": True,
            "text": msg,
            "username": "GibernoBot",
            "chat_type": t_chat.get("type", None)
